...
hl.window_rule({match = {class = "^(dash-rmpc)$" },   float = true, workspace = "2", move = {1, 46},    size = {958, 786} })
hl.window_rule({match = {class = "^(dash-clock)$" },  float = true, workspace = "2", move = {961, 46},  size = {409, 242} })
hl.window_rule({match = {class = "^(dash-pomo)$" },   float = true, workspace = "2", move = {961, 290}, size = {409, 284} })
hl.window_rule({match = {class = "^(dash-matrix)$" }, float = true, workspace = "2", move = {961, 576}, size = {409, 256} })
hl.window_rule({match = {class = "^(dash-yazi)$" },   float = true, workspace = "2", move = {1372, 46}, size = {547, 786} })
hl.window_rule({match = {class = "^(dash-cava)$" },   float = true, workspace = "2", move = {1, 834},   size = {1918, 245} })

hl.window_rule({match = { class = "^dash2-tdf$" },    float = true, workspace = "3", move = {1, 46},     size = {1556, 1033} })
hl.window_rule({match = { class = "^dash2-matrix$" }, float = true, workspace = "3", move = {1559, 46},  size = {360, 545} })
hl.window_rule({match = { class = "^dash2-pomo$" },   float = true, workspace = "3", move = {1559, 593}, size = {360, 265} })
hl.window_rule({match = { class = "^dash2-clock$" },  float = true, workspace = "3", move = {1559, 860}, size = {360, 219} })
