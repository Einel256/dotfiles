...
hl.bind("SUPER + R", hl.dsp.exec_cmd("pgrep -x rofi >/dev/null && pkill -x rofi || " .. menu))
hl.bind("SUPER + Tab", hl.dsp.exec_cmd("hyprlock"))

hl.bind("SUPER + N", hl.dsp.global("quickshell:searchToggleRelease"))
hl.bind("ALT + Right", hl.dsp.focus({ workspace = "r+1" }), { description = "Workspace: Focus Right" })
hl.bind("ALT + Left", hl.dsp.focus({ workspace = "r-1" }), { description = "Workspace: Focus Left" })
hl.bind("ALT + L", hl.dsp.focus({ workspace = "r+1" }), { description = "Workspace: Focus Right" })
hl.bind("ALT + H", hl.dsp.focus({ workspace = "r-1" }), { description = "Workspace: Focus Left" })
...
hl.bind("SUPER + A", hl.dsp.exec_cmd("hyprctl switchxkblayout current next"))
hl.bind("SUPER + X", hl.dsp.global("quickshell:overviewClipboardToggle"))
hl.bind("SUPER + Period", hl.dsp.global("quickshell:overviewEmojiToggle"))
hl.bind("SUPER + ALT + A", hl.dsp.global("quickshell:sidebarLeftToggleDetach"))
hl.bind("SUPER + C", hl.dsp.global("quickshell:sidebarLeftToggle"))
hl.bind("SUPER + V", hl.dsp.global("quickshell:sidebarRightToggle"), { description = "Shell: Toggle right sidebar" })
hl.bind("SUPER + Slash", hl.dsp.global("quickshell:cheatsheetToggle"), { description = "Shell: Toggle cheatsheet" })
hl.bind("SUPER + SHIFT + K", hl.dsp.global("quickshell:oskToggle"), { description = "Shell: Toggle on-screen keyboard" })


hl.bind("SUPER + M", hl.dsp.exec_cmd("/usr/bin/music.sh & /usr/bin/study.sh &"), { description = "App: Music & Study script" })
hl.bind("SUPER + SHIFT + M", hl.dsp.exec_cmd("/usr/bin/musicstop.sh &"), { description = "App: Stop music script" })

hl.bind("SUPER + B", hl.dsp.exec_cmd("zen-browser  &"), { description = "Zen" })
...
for i = 1, 4 do
    local key = { "SUPER + CTRL + mouse_up", "SUPER + CTRL + mouse_down" }
    local keycombos = { key[1], key[2], "CTRL + " .. key[1], "CTRL + " .. key[2] }
    local prefix = { "+", "-", "r+", "r-" }
    hl.bind(keycombos[i], hl.dsp.focus({ workspace = prefix[i] .. "1" }))
end
...
hl.bind("CTRL + SUPER + X", hl.dsp.exec_cmd(volumeMixer), { description = "App: Volume mixer" })
